...
void append_page_header() {
  ...
  webpage += F("<head>");
  webpage += F("<title></title>"); // NOTE: 1em = 16px
  webpage += F("<meta name='viewport' content='user-scalable=yes,initial-scale=1.0,width=device-width'>");
  webpage += F("<style>");//From here style:
  webpage += F("body{max-width:65%;margin:0 auto;font-family:Bahnschrift SemiLight Condensed;font-size:100%;}");
  ...
  webpage += F("h1{color:white;border-radius:0em;font-size:1.5em;padding:0.2em 0.2em;background:#FF75F6;}");
  ...
  webpage += F("</style></head><body><h1>SD Card</h1>");
